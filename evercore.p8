...
fall_floor={
	...
	update=function(this)
		...
		elseif this.state==1 then
			...
			if this.delay<=0 then
				...
				this.type.set_springs(this,false)
			end
		...
		elseif this.state==2 then
			...
			if this.delay<=0 and not this.player_here() then
				...
				this.init_smoke()
				this.type.set_springs(this,true)
			end
		end
	end,
	draw=function(this)
	...
	set_springs=function(this,state)
		this.hitbox=rectangle(-2,-2,12,8)
		local springs=this.check_all(spring,0,0)
...

...

...

